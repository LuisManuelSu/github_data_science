This repository include the projects I have created related to data science.

Python Beginners:
- ranked_related_movies_omdb_and_tastedive.py | 25.09.2020 | A program to look for the related movies for a list of movies gived by the user
